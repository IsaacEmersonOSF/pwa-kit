...
describe('utils/ssr-server tests', () => {
  test('getFullRequestURL', () => {
    ...
    expect((0, _ssrServer.getFullRequestURL)(`${_constants.PROXY_PATH_PREFIX}/base/somepath`)).toBe('https://www.merlinspotions.com/somepath');
    expect((0, _ssrServer.getFullRequestURL)(`${_constants.PROXY_PATH_PREFIX}/base2/somepath`)).toBe('https://api.merlinspotions.com/somepath');
  });
